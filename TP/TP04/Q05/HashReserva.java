...
class Hash {
    ...
    public int pesquisar(Personagem perso, Log log) {
        int resp = -1;
        int pos = h(perso);
...
public class HashReserva extends Personagem {
    public static void main(String[] args) throws Exception {
        Scanner scan = new Scanner(System.in);
        Personagem[] personagens = new Personagem[100];
        Hash hash = new Hash();
        Log log = new Log("801779_hashReserva.txt");
        Personagem perso = new Personagem();
