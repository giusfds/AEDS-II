...
public class CountingSort {
    ...
    public static void ordenaCounting(ArrayList<Personagem> personagens, Log log) {
        int[] count = new int[getMaior(personagens, log) + 1];
    ...
    public static int getMaior(ArrayList<Personagem> personagens, Log log) {
    ...
    public static void main(String[] args)throws Exception {
        ...
        log.pesquisa("801779_countingsort.txt", timer);
