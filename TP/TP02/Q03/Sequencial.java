...
public class Sequencial {    
    ...
    public static void main(String[] args)throws Exception {
        RandomAccessFile RF = new RandomAccessFile("characters.csv", "r");
        ...
        timer.Start();
        while (!(str=sc.nextLine()).equals("FIM") ) {
            // fazer pesquisa sequencial por nome da funcao
            System.out.println(PesquisaSequencial(str, BD2, log) ? "SIM" : "NAO");
        }
        timer.Stop();

        log.pesquisa("801779_sequencial.txt", timer);
